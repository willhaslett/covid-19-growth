...
# Set up dataframe. df_all is all raw data converted to long format with dates as Pandas timestamps
...
# Filter out non-US, rename columns, split state into column
